...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
        ...
        <!--begin::Aside-->
        <!--begin::Content-->
        <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0 login-bg text-white" style="background-color: #96c3f2">
            <!--begin::Title-->
            {{-- <div class="d-flex flex-column justify-content-center text-center pt-15">
                <h3 class="display4 font-weight-bolder my-7 text-dark" >{{  Config::get('constants.SYSTEM_NAME'); }}</h3>

            </div> --}}
            <!--end::Title-->
            <!--begin::Image-->
            {{-- <div class="content-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url({{  asset('backend/assets/media/svg/illustrations/login-visual-2.svg') }} );"></div> --}}
           <!--begin::Image-->
					<div class="content-img d-flex flex-row-fluid bgi-no-repeat  bgi-position-x-center" style="background-image: url({{  asset('backend/media/bg/login.png') }}) ; background-size:cover"></div>
            <!--end::Image-->
            <!--end::Image-->
        </div>
        <!--end::Content-->
